...
###Explore precoloniser persistance (Fig 2)
```{r fig2}
...
###Rarefying exploration (incl. Fig 3)
...
###Heat tree for each precoloniser, with node size by abundance and colour by number of occurrances (Fig 7)
```{r fig7}
{
...
#Combine the 'precoloniser' trees into one plot (Fig. 2a)
...
###Heat tree for each precoloniser, with node size by abundance and colour by number of occurrances (Fig 6)
```{r fig6}
{
