...
##Bar-and-strip plots of growth rate, panelled by fungal species (Figs 3&4)
```{r figs3&4, results='hide'}
pdf("ten_growth_rates.pdf", height=10, width=12)
ggplot(ten, aes(x = Treatment, y = Growth.rate)) +
  ...
  facet_wrap(~Fungus) +
  labs(x="Treatment", y="Growth rate (mm/day)") +
  theme_bw()
dev.off()
pdf("twenty_growth_rates.pdf", height=10, width=12)
ggplot(twenty, aes(x = Treatment, y = Growth.rate)) +
  geom_boxplot(notch=FALSE, outlier.colour = "#ffffff") +
...
##Bar-and-strip plot of migration (Fig 2)
```{r fig2, results='hide'}
...
##Barcharts of interaction outcomes (Figs 5&6)
```{r figs5&6, results='hide', warning=FALSE}
